...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(4)                          :: DAC_Mode                     ! DAC actuator mode {0: off, 1: fixed dac parameter, 2: PI DAC control, 3: Shutdown control only}
    INTEGER(4)                          :: dac_type                     ! DAC actuator type {0: TE Flap, 1: LE Spoiler}
    REAL(8)                             :: dac_param                    ! DAC Param (if a flap angle, it is in deg)
